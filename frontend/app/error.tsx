  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f4f5f4", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "system-ui,sans-serif" }}>
      <div style={{ textAlign: "center", padding: "40px 24px" }}>
        ...
        <button type="button" onClick={reset} style={{ background: "#1B3D2B", color: "#fff", padding: "12px 24px", border: "none", borderRadius: 10, fontWeight: 700, fontSize: 14, cursor: "pointer" }}>Erneut versuchen</button>
      </div>
    </div>
  );
}
